...
reg  csrbank3_osing_re = 1'd0;
wire csrbank3_osing_r;
reg  csrbank3_osing_we = 1'd0;
wire csrbank3_osing_w;
wire csrbank3_sel;
...
assign csrbank3_osing_r = interface3_bank_bus_dat_w[0];
always @(*) begin
	csrbank3_osing_we <= 1'd0;
	csrbank3_osing_re <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank3_osing_re <= interface3_bank_bus_we;
		csrbank3_osing_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_osing_w = infrarojo_cntrl_status;
assign infrarojo_cntrl_we = csrbank3_osing_we;
...
always @(posedge sys_clk) begin
	...
	if (csrbank3_sel) begin
		case (interface3_bank_bus_adr[8:0])
			1'd0: begin
				interface3_bank_bus_dat_r <= csrbank3_osing_w;
			end
		endcase
	end
	infrarojo_cntrl_re <= csrbank3_osing_re;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-02-10 17:26:09.
//------------------------------------------------------------------------------
