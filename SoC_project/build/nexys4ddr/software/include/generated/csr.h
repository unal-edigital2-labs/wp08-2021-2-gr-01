//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (e9aa747d) on 2022-02-08 19:08:47
//--------------------------------------------------------------------------------
...
/* movimiento_cntrl */
#define CSR_MOVIMIENTO_CNTRL_BASE (CSR_BASE + 0x3800L)
#define CSR_MOVIMIENTO_CNTRL_ESTADO_ADDR (CSR_BASE + 0x3800L)
#define CSR_MOVIMIENTO_CNTRL_ESTADO_SIZE 1
static inline uint32_t movimiento_cntrl_estado_read(void) {
	return csr_read_simple(CSR_BASE + 0x3800L);
}
static inline void movimiento_cntrl_estado_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x3800L);
}

/* servomotor_cntrl */
#define CSR_SERVOMOTOR_CNTRL_BASE (CSR_BASE + 0x4000L)
#define CSR_SERVOMOTOR_CNTRL_POSICION_ADDR (CSR_BASE + 0x4000L)
#define CSR_SERVOMOTOR_CNTRL_POSICION_SIZE 1
static inline uint32_t servomotor_cntrl_posicion_read(void) {
	return csr_read_simple(CSR_BASE + 0x4000L);
}
static inline void servomotor_cntrl_posicion_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x4000L);
}

/* ultrasonido_cntrl */
#define CSR_ULTRASONIDO_CNTRL_BASE (CSR_BASE + 0x4800L)
#define CSR_ULTRASONIDO_CNTRL_INIT_ADDR (CSR_BASE + 0x4800L)
#define CSR_ULTRASONIDO_CNTRL_INIT_SIZE 1
static inline uint32_t ultrasonido_cntrl_init_read(void) {
	return csr_read_simple(CSR_BASE + 0x4800L);
}
static inline void ultrasonido_cntrl_init_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x4800L);
}
#define CSR_ULTRASONIDO_CNTRL_DISTANCE_ADDR (CSR_BASE + 0x4804L)
#define CSR_ULTRASONIDO_CNTRL_DISTANCE_SIZE 1
static inline uint32_t ultrasonido_cntrl_distance_read(void) {
	return csr_read_simple(CSR_BASE + 0x4804L);
}
#define CSR_ULTRASONIDO_CNTRL_DONE_ADDR (CSR_BASE + 0x4808L)
#define CSR_ULTRASONIDO_CNTRL_DONE_SIZE 1
static inline uint32_t ultrasonido_cntrl_done_read(void) {
	return csr_read_simple(CSR_BASE + 0x4808L);
}

/* infrarojo_cntrl */
#define CSR_INFRAROJO_CNTRL_BASE (CSR_BASE + 0x5000L)
#define CSR_INFRAROJO_CNTRL_OL_ADDR (CSR_BASE + 0x5000L)
#define CSR_INFRAROJO_CNTRL_OL_SIZE 1
static inline uint32_t infrarojo_cntrl_oL_read(void) {
	return csr_read_simple(CSR_BASE + 0x5000L);
}
#define CSR_INFRAROJO_CNTRL_OLC_ADDR (CSR_BASE + 0x5004L)
#define CSR_INFRAROJO_CNTRL_OLC_SIZE 1
static inline uint32_t infrarojo_cntrl_oLC_read(void) {
	return csr_read_simple(CSR_BASE + 0x5004L);
}
#define CSR_INFRAROJO_CNTRL_OC_ADDR (CSR_BASE + 0x5008L)
#define CSR_INFRAROJO_CNTRL_OC_SIZE 1
static inline uint32_t infrarojo_cntrl_oC_read(void) {
	return csr_read_simple(CSR_BASE + 0x5008L);
}
#define CSR_INFRAROJO_CNTRL_ORC_ADDR (CSR_BASE + 0x500cL)
#define CSR_INFRAROJO_CNTRL_ORC_SIZE 1
static inline uint32_t infrarojo_cntrl_oRC_read(void) {
	return csr_read_simple(CSR_BASE + 0x500cL);
}
#define CSR_INFRAROJO_CNTRL_OR_ADDR (CSR_BASE + 0x5010L)
#define CSR_INFRAROJO_CNTRL_OR_SIZE 1
static inline uint32_t infrarojo_cntrl_oR_read(void) {
...
#define CSR_CAMARA_CNTRL_ERROR_ADDR (CSR_BASE + 0x5804L)
...
#define CSR_CAMARA_CNTRL_RES_ADDR (CSR_BASE + 0x580cL)
